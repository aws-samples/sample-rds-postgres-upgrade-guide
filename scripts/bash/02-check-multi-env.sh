...
# WARNING: Review and update the connection strings below with your actual environments before running.
# The example values are placeholders only — do not execute without verifying each entry.
ENVS=(
